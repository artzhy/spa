...
(function (spa) {
    ...
    (function (controls) {
        ...
        ko.components.register(PushButton.componentName, {
            ...
            template: "<button class=\"button\" type=\"button\" data-bind=\"     attr: { title: title, type: type },     click: function(data, ev) { onClick($parent, ev); },     css: className,     disable: disabled,     html: text\"></button>"
        });
    })(controls = spa.controls || (spa.controls = {}));
})(spa || (spa = {}));
var spa;
